...
void main(){
	printf("You are standing in the street.\n\
A mere three years ago that\'d have been a pretty risky move. \
These days it just means you get a better view of the Shard.\n\
To help with the adjustment, you\'ve been left some programs. \
...
! As you can\'t use your mouse or touchscreen here, that means \
